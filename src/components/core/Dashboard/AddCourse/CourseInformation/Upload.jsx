    ...
    <div>
        {
            ...
            (
                <div className="flex flex-col space-y-2">
                    ...
                    <label className=' text-sm text-gray-50' htmlFor={label}>
                        <div>
                            Course Thumbnail <sup className=' text-pink-500'>*</sup>
                        </div>

                        <div className="bg-gray-700 flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-gray-500">
                            <div

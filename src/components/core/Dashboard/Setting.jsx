...
import { updateProfilePicture, updateAdditionalDetails, deleteAccount, updatePassword } from "../../../services/operations/profileApi";
...
function Setting() {
  ...
  //update profile
  const intitialProfilePicture = useSelector(
    (state) => state.profile?.user?.image,
  );
  const [profilePicture, setProfilePicture] = useState(intitialProfilePicture);
  ...
  return (
    <div>
      <div className=" flex-1 overflow-auto">
        ...
        <h1 className=" mb-14 text-3xl font-medium text-gray-50">Edit Profile</h1>

        {/*upadte profile picture */}
        <div className="flex items-center justify-between rounded-md border-[1px] border-gray-700 bg-gray-800 md:p-8 md:px-12 px-3 py-3 text-gray-50">
            ...
            <div className='space-y-2'>
              ...
              <form onSubmit={handleUpload}>
                <div className='flex flex-row gap-3'>
                  ...
                  <button type="submit"
                  className='flex items-center bg-yellow-400 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-gray-900'
                  >
                    Upload
                  </button>
                </div>
        ...
        <div>
          <form onSubmit={handleAdditionalDetails}>
            <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-gray-700 bg-gray-800 p-8 px-12">
              <h2 className="text-lg font-semibold text-gray-50">Profile Information</h2>
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
              <div className="flex flex-col gap-2 lg:w-[48%]">
                <label htmlFor="contactNumber" className="text-gray-400">Contact Number</label>
              ...
              <div className="flex flex-col gap-2 lg:w-[48%]">
                <label htmlFor="about" className="text-gray-400">About</label>
            ...
            <div className="flex justify-end gap-2">
              <button className="flex items-center bg-yellow-400 cursor-pointer 
              gap-x-2 rounded-md py-2 px-5 font-semibold text-gray-900" 
              type="submit">
                Save
              </button>
          </div>
        ...
        <div>
          <form onSubmit={handlePassword}>
            <div>
              ...
              <div className=' relative mt-4'>
                <label className="w-full"><p className="mb-1 text-[0.875rem] leading-[1.375rem] text-gray-50">New Password <sup className="text-pink-200">*</sup></p>
                <input
                    required
              ...
              <div className=' relative mt-4'>
                <label className="w-full"><p className="mb-1 text-[0.875rem] leading-[1.375rem] text-gray-50">Confirm New Password <sup className="text-pink-200">*</sup></p>
                <input
                    required
                    type={showConfirmPassword ? "text" : "password"}
            ...
            <div className="flex justify-end gap-2 mt-3">
              <button className="flex items-center bg-yellow-400 cursor-pointer gap-x-2 
              rounded-md py-2 px-5 font-semibold text-gray-900 undefined" 
              type="submit">
                Save
              </button>
            </div>
        ...
        <div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-3 md:p-8 md:px-12">
          ...
          <div className="flex flex-col space-y-2 w-full">
            ...
            <div className="md:w-3/5 text-pink-300">
            ...
            <button type="button" onClick={onDeleteAccount} className="w-fit cursor-pointer italic text-pink-700">I want to delete my account.</button>

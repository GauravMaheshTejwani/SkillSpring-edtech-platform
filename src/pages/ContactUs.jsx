      ...
      <div className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white lg:flex-row">
        <div className="lg:w-[40%]">
          <div className="flex flex-col gap-6 rounded-xl bg-gray-800 p-4 lg:p-6">
            <div className="flex flex-col gap-[2px] p-3 text-sm text-gray-400">
              ...
              <p className="font-semibold">info@SkillSpring.com</p>
            </div>
        ...
        <div className="lg:w-[60%]">
          <div className="border border-gray-600 text-gray-500 rounded-xl p-7 lg:p-14 flex gap-3 flex-col">
            <h1 className="text-4xl leading-10 font-semibold text-gray-50">

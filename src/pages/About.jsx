...
const About = () => {
  return (
    <div className='mx-auto text-white'>
        ...
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
          <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
            ...
            <p className='mx-auto mt-3 text-center text-base font-medium text-gray-400 lg:w-[95%]'>
              SkillSpring is at the forefront of driving innovation in online
      ...
      {/**Section 3 */}
      <section className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-gray-500'>
        <div>
          {/**Founding story */}
          ...
          <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[40%] flex-col gap-10">
              ...
              <p className="text-base font-medium text-gray-00 lg:w-[95%]">
      ...
      {/**review slider */}
      <section className=' mb-16 mt-3 w-screen'>
        <h2 className='text-center text-4xl font-semibold mt-8 text-gray-50 mb-5'>Reviews from Other learners</h2>
        <ReviewSlider />
      </section>
    </div>
  );

...
const SearchCourse = () => {
  ...
  return (
    <div>
        <div className='mx-auto flex min-h-[260px]  flex-col justify-center gap-4 p-5 bg-gray-800'>
            <p className='text-sm text-gray-500'>Home / Search / <span>{searchQuery}</span></p>
            <p className='text-3xl text-gray-50'>Search Results for {searchQuery}</p>
...

        {
            ...
            searchResults?.length === 0 ? (<div className='mx-auto flex min-h-[500px] items-center  flex-col justify-center gap-4 p-5 bg-gray-900 '>
                <p className='text-3xl text-gray-50'>No Results Found</p>
                <HiOutlineEmojiSad className=' text-gray-400 text-[100px]' />
            </div>):(
